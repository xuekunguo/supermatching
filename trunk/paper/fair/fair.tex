...
\teaser{
  ...
  \caption{Correspondences between datasets determined by SuperMatching, using feature points created by the uniform sampling on the left rigid scans and SIFT feature points on the right deformable surface. For clarity, only some representative matches are shown.}
}
