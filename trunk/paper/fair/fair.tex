...
\teaser{
  ...
  \caption{Correspondences between 3D datasets determined by SuperMatching, using feature points created by the uniform sampling on the upper and lower shapes.
  For clarity, only 78 representative matches are shown.}
}
