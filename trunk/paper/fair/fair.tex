...
\teaser{
  \includegraphics[width=0.98\linewidth]{figures/teaser.jpg}
  \caption{\cz{Correspondences between 3D datasets determined by SuperMatching, using the feature points created by the uniform sampling on the upper and bottom shapes.
  For the clear visualization, only 78 matchings are showed.}}
}
