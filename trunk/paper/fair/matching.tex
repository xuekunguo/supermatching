...
we employ random sampling for general feature correspondence problems as there is no guidance to provide a better sampling method.
...
The sampling cost is $O(N_1\, t_1\,  k\log n)$.
