...
\title{Feature Matching using Supersymmetric Geometric Constraints}
...
\teaser{
%   \includegraphics[width=0.99\linewidth]{figs/teaser}
%   \caption{The pattern shown in (a) is very common in many buildings, where the structure is reflectively symmetric, but each part is asymmetric. (b) shows an example of nested symmetric patterns.(c)-(e) are three asymmetric buildings.}\label{fig:teaser}
}
